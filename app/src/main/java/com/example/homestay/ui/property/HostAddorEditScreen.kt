    ...
    fun HostAddOrEditHomeScreen(
        ...
        // For tablet/desktop, increase max width of content
        val maxContentWidth = when {
            screenWidth < 600 -> screenWidth.dp // phone: full width
            screenWidth < 900 -> 600.dp // small tablet: max 600dp
            else -> 800.dp // large tablet: max 800dp
        }
